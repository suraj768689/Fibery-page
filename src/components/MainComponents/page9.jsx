      ...
      <div className="w-full mx-auto"> {/* Adjust width based on screen size */}
        ...
        <div className="w-full mt-10 mx-auto"> {/* Adjust max width based on screen size */}
          <div className="max-w-4xl"> {/* Increase max width */}
            <div className="bg-green-100 rounded-lg shadow-md p-6 pr-4"> {/* Added pr-4 for padding adjustment */}
              <p className="text-xl md:text-2xl text-left">We won't teach you data analysis; so if you haven't done it before, you'll need to invest some time & effort.</p>
